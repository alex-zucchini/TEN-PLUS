...
let ZBRangeSlider = function (id) {
    ...
    let touchLeft = slider.querySelector('.range-slider__touch-left');
    let touchRight = slider.querySelector('.range-slider__touch-right');
    let lineSpan = slider.querySelector('.range-slider__line span');
    ...
    // normalize flag - edit if you changed any sizes and slider doesn't work correctly
    let normalizeFact = 6;
    ...
    function calculateValue() {
        ...
        minValue = lineSpan.offsetLeft / initialValue;
